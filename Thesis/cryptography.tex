...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{AddRoundKey.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{SubBytes.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{ShiftRows.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{MixColumns.png}
